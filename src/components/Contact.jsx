...
function Contact() {
  return (
    <section id="contact" className="mx-auto max-w-6xl px-5 py-24">
      <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-white/4 p-8 md:p-12">
        ...
        <h2 className="max-w-3xl text-4xl font-medium tracking-tighter md:text-6xl">
        ...
        <Button asChild className="mt-8" size="lg">
          <a href="mailto:aditya.manoj.shinde@gmail.com">
